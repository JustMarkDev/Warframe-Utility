...
2) A serious issue is the limit for listings that warframe.market sets for non-subscribers.
  ...
  2.1) The user may not want to sell as fast as possible, but to gain as much platinum per standing as possible. Should implement a function
...
3) I began to create the web interface, but the logic is wonky, and there are 2 main issues i need to address:
  1) error in the logic that recomputes the available standing after you sell mods
  2) the slider doesn't visually update after selling
