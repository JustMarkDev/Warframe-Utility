...
steel_meridian_mods = {
    ...
    2: [], # Valiant
    3: [], # Defender
    4: [   # Protector (Weapon Augments)
        "scattered_justice",     # Hek
        "justice_blades",        # Dual Cleavers
        "neutralizing_justice",  # Miter
        "shattering_justice"     # Sobek
    ],
    5: [   # General (Warframe Augments)
        # Atlas
